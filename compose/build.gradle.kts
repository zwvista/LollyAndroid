...
android {
    namespace = "com.zwstudio.lolly.compose"

    defaultConfig {
        applicationId = "com.zwstudio.lolly.compose"
        minSdk = 24
        compileSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.compose.runtime:runtime-livedata:${rootProject.extra["compose_ui_version"]}")
