...
class PhrasesLangFragment : DrawerListFragment() {
    ...
    override fun onResume() {
        ...
        compositeDisposable.add(vm.getData().subscribe {
            ...
            val listAdapter = PhrasesLangItemAdapter(vm, mDragListView, R.layout.list_item_phrases_lang_edit, compositeDisposable)
